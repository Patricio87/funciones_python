...
def contar():
    numero_tres = mi_lista_aleatoria.count(3)
    return numero_tres
...
if __name__ == '__main__':
    ...
    cantidad_numeros_tres = contar()
    print("La cantidad de veces que se repite el numero 3 es:", cantidad_numeros_tres)
